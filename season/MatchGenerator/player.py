...
class Player():
    ...
    def __init__(self,Player_name, Nation, Team, Home_Away, Position, Division_Rank, \
    ...
    def attack(self,intensity, general):
    ...
    def defense(self,intensity, general):
    ...
    @classmethod
    def calculate_max_performance_home_attack(cls, general):
    ...
    @classmethod
    def calculate_max_performance_away_attack(cls, general):
